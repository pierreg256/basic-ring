defmodule BasicRing.NodeListener do
  @moduledoc """
  ...
  def init(cluster) do
    Logger.debug("Starting NodeListener for #{inspect(cluster)}")
  ...
  defp set_members(cluster, timeout \\ 5000) do
    GenServer.call(cluster, {:set_members, make_members(cluster)}, timeout)
  end

  # do: :ok = Horde.Cluster.set_members(cluster, )
